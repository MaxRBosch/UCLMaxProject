...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MinvalService", function() { return MinvalService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


let MinvalService = class MinvalService {
    constructor() { }
    min_value() {
...
MinvalService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let PredictionsService = class PredictionsService {
    ...
    predict_api(ibm_prediction_time, crypto) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                var res = yield axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(url, data, axiosConfig);
                ...
                if (crypto == 'btc') {
                    var scoring_url = yield axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("https://cors-anywhere.herokuapp.com/https://eu-gb.ml.cloud.ibm.com/v4/deployments/6110091e-dcc1-4b34-a97b-64b05d0f9601/predictions  ", payload, axiosConfigresult);
                }
                else {
                    var scoring_url = yield axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("https://cors-anywhere.herokuapp.com/https://eu-gb.ml.cloud.ibm.com/v4/deployments/bc21f2a3-0e80-4f81-a4bf-844a5770c407/predictions", payload, axiosConfigresult);
                }
                ...
                let res = yield axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('https://nodemrbosch.azurewebsites.net/api/error', { params: { userID: userID, type: crypto, time: Date.now() } });
            }
        });
    }
};
...
PredictionsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], PredictionsService);
