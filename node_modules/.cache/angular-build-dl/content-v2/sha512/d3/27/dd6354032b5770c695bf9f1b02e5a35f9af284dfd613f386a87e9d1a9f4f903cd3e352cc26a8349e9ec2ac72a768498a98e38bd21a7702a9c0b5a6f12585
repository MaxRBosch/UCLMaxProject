...
let EthPage = class EthPage {
    ...
    save(prediction) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            let res = yield axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('https://nodemrbosch.azurewebsites.net/api/addprediction', { params: { userID: userID, type: 'eth', time: Date.now(), value: prediction } });
            return;
        });
    }
    get_chart() {
