...
let BtcPage = class BtcPage {
    ...
    predict_ibm() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const res = yield (yield this.ibmmodel.predict_api(this.ibm_prediction_time, 'btc')).prediction_ibm;
            var array_values = yield (yield this.ibmmodel.predict_api(this.ibm_prediction_time, 'btc')).time;
            if (res != null) {
